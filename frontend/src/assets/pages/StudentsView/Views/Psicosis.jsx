...
import preguntasPsicosis from "../../../data/preguntasPsicosis";
...
export default function Psicosis() {

  let { psicosis, onSubmitPsicosis } = useContext(VistaUserContext)

  const {
    control,
    handleSubmit,
    formState: { errors },
  } = useForm({ defaultValues: psicosis });

  const onSubmit = (data) => {
    // Your form submission logic goes here
    onSubmitPsicosis(data);
  };
          ...
          >
            <TableContainer component={Paper} style={{ height: "48vh" }}>
              <Table>
                ...
                <TableBody>
                  {preguntasPsicosis.map((pregunta) => (
